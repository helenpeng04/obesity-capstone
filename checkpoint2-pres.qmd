...
## Counties differ in obesity rates based on lifestyle and food environment
...
-   **Clusters 1 & 2**: Improve access to parks and outdoor recreational spaces to help reduce physical inactivity and support healthier lifestyles.

-   **Cluster 3**: Given the high frequency of extreme heat days, outdoor solutions may be less effective. Instead, prioritize investment in indoor facilities such as community gyms or wellness centers.
...
```{r beta_diagnostics, include = FALSE}


```

```{r decision_tree, include = FALSE}
