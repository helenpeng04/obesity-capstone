...
data_2025 <- data_2025 |> 
  mutate(
    ...
    median_income_k = median_household_income / 1000
  )

huber_model <- rlm(logit_obesity ~ food_environment_index + percent_physically_inactive, 
                   data = data_2025)

huber_model2 <- rlm(logit_obesity ~ median_income_k + percent_limited_access_to_healthy_foods + percent_physically_inactive, 
                    data = data_2025)
