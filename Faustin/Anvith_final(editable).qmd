...
pretty_labels_fei <- c(
  ...
  "percent_physically_inactive" = "Physically Inactive (%)",
  "number_completed_high_school" = "High School Graduates",
  "population_173" = "Population (Age 17-3)"
)

# Get top 10 predictors and apply labels
...
vip(top_vi_fei, aesthetics = list(fill = "darkgreen")) +
  labs(y = "Variable Importance (Total Reduction in RSS)",
       title = "Top Predictors of Food Environment Index") +
  theme_minimal()
```
