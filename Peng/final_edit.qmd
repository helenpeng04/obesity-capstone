...
ggplot(coef_df, aes(x = OR, y = term)) +
  ...
  geom_errorbarh(aes(xmin = OR_low, xmax = OR_high), height = 0.2, color = "gray30") +
...
summary(lm(logit_obesity ~ percent_food_insecure + percent_physically_inactive + food_environment_index, data = data_2025))
```
